...
- `git clone https://github.com/UniversalPropositions/UP_Czech-CLTT.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Czech-CLTT>/ --input_up=<up_path_to_UP_Czech-CLTT>/ --output=<path_to_UD+UP_Czech-CLTT>/`
